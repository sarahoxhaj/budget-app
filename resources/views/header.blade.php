        ...
        <div class="center p-6 h-4/5 w-2/4" style="text-align: center">
            ...
            <div class="grid grid-cols-2 " style="margin-top: 30px;">
                <div>Using social media accounts
                    <br>
                    <br>
                    <a href="#" class="tn-google text-white bg-red-500 hover:bg-red-500 focus:ring-4 focus:outline-none focus:ring-red-500 font-medium rounded-lg text-sm px-8 py-2.5 text-center inline-flex items-center dark:focus:ring-red-500 mr-2 mb-2"><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-google" viewBox="0 0 16 16">
