...
<header>
    <div class="w-full h-2/3" style="background-color: #009933">
        ...
        <div class="center p-10 h-3/4 w-2/4" style="text-align: center">
            <b>
                <p class="text-2xl">Log In</p>
            </b>
            <div class="grid grid-cols-2 divide-x-4" style="margin-top: 30px;">
                    ...
                    <div class="w-full max-w-xs">
                        <form class="rounded px-8  pb-8 mb-4">
                            ...
                            <div class="flex items-center justify-between">
                                <button class="bg-blue-500 hover:bg-blue-700 text-white font-bold py-2 pt-1 px-4 rounded focus:outline-none focus:shadow-outline" type="button">
                                    Sign In
                                </button>
