...
<div class="div2 h-auto w-2/5" style="text-align: center">
    <form action="{{route('transaction')}}" method="POST">
        ...
        <!-- <div class="relative w-11/12 ml-6">
            ...
            <input disabled id="date" name="date" class="shadow appearance-none border rounded bg-slate-100 border border-gray-300 text-gray-800 sm:text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full pl-10 p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500">
            <div class="text-sm text-red-700 dark:bg-red-200 dark:text-red-800" role="alert">
                <span class="font-medium">@error('date'){{$message}}@enderror</span>
            </div>
        </div> -->
